<template>
  ...
  <q-page class="flex flex-center" style="background-color: lightgrey">
    ...
    >
      ...
      <div class="row">
        <div
          class="col-xs-0 col-md-0 q-my-lg"
        ...
        <div
          class="col-xs-0 col-md-2 q-my-lg"
        ...
        >
          ...
          <div>
            ...
            possible for yourself, if the person you're working with is also
            making money. That's life!
          </div>
        </q-card-section>
      </div>
      <div class="row">
      ...
      <div style="text-align: right">Last Updated on August 9th, 2022</div>
    </div>
  </q-page>
</template>
